...
noise      = "lognormal_background_log_scale"

dir.create("analyses/simulation_study/simulation_3/jobs", showWarnings=FALSE)
...
# read the stub
lines = readLines("analyses/simulation_study/simulation_3/src/template.Rev")
...
for(i in 1:nrow(grid)) {
  ...
  this_file = paste0("analyses/simulation_study/simulation_3/jobs/job_",i,".Rev")
