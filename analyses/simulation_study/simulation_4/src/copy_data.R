cat("copying data from simulation 2.\n")
...
for(i in 1:nrow(grid)) {
  ...
  # source directory
  source = paste0("analyses/simulation_study/simulation_2/data/n_",num,"/k_",k,"/g_",g,"/t_",tree)

  # target directory
  target = paste0("analyses/simulation_study/simulation_4/data/n_",num,"/k_",k,"/g_",g)
