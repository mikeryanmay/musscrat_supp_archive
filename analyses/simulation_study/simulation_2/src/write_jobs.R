...
dir.create("analyses/simulation_study/simulation_2/jobs", showWarnings=FALSE)
...
# read the stub
lines = readLines("analyses/simulation_study/simulation_2/src/template.Rev")
...
for(i in 1:nrow(grid)) {
  ...
  this_file = paste0("analyses/simulation_study/simulation_2/jobs/job_",i,".Rev")
