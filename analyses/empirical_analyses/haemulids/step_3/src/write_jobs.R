...
# read the stub
lines = readLines("analyses/empirical_analyses/haemulids/step_3/src/template.Rev")
...
for(i in 1:nrow(grid)) {
  ...
  this_file = paste0("analyses/empirical_analyses/haemulids/step_3/jobs/job_",i,".Rev")
